...
- 【将来の検討課題】classificationは季非依存（現在の区分を全シーズンに一律適用）の設計のため、
  シーズンをまたいだ外国籍→帰化選手/アジア特別枠への切り替わりを正確に表現できない（例: ある
  選手が2016-17は外国籍だったが後に帰化した場合、全シーズンで帰化選手として扱われる）。現状は
  「外国籍/帰化/アジア特別枠のグループ」対「日本人」という大枠の区別が正しければ十分と判断し、
  優先度は低いまま保留する。正確に扱いたくなった場合は、season-rosters.jsonと同様のシーズン軸を
  持つ登録区分アーカイブが必要になる
