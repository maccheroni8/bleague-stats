...
export interface TeamTotals {
  ...
  oppMid2a: number;
  /**
   * 登録区分別得点（日本人/外国籍・帰化・アジアの2分割）。TeamGameLog由来
   * （foreignPoints + naturalizedOrAsianPointsを合算して2区分に統一する。
...
export function buildScoringColumns(
  ...
  return [
    ...
    classificationSupported
      ...
      : unavailableColumn("japanesePts3", "日本人 PTS"),
    classificationSupported
      ? countColumn(
          "internationalPts3",
          "外国籍・帰化・アジア PTS",
      ...
      : unavailableColumn("internationalPts3", "外国籍・帰化・アジア PTS"),
    classificationSupported
      ? pct100Column(
          "pctjapanese3",
          "%日本人 PTS",
      ...
      : unavailableColumn("pctjapanese3", "%日本人 PTS"),
    classificationSupported
      ? pct100Column(
          "pctinternational3",
          "%外国籍・帰化・アジア PTS",
      ...
      : unavailableColumn("pctinternational3", "%外国籍・帰化・アジア PTS"),
